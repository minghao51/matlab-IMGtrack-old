...
corrcoef(handles.TumourXcentroid,handles.DiaphragmYbound)
corrcoef(handles.TumourYcentroid,handles.DiaphragmYbound)
X=handles.TumourXcentroid;
Y=handles.TumourYcentroid;
DY=handles.DiaphragmYbound;
...
% Add labels
hTitle  = title ('Scatter plot of Diaphragm Height & CtumourY ');
hXLabel = xlabel('Normalised CtumourY Parameter\it ( C ) \it '       );
