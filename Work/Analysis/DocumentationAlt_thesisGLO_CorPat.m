...
LineWidth = 2;
%% Segmentation method 2: Global Otsu method
...
[ handles ] = FeatureExtract( handles.GOGI1,handles.LOGI2, handles );
...
hTitle  = title ('Probability Density function plot for "Cor Pat Scan" ');
